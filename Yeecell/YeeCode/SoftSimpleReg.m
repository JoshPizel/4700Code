...
% epi{1}(130:150,55:95)= c_eps_0*11.3;
% epi{1}(90:110,55:95)= c_eps_0*11.3;
% epi{1}(50:70,55:95)= c_eps_0*11.3;
% epi{1}(10:30,55:95)= c_eps_0*11.3;
startingX = 100;
startingY = 50;
height = 40;
length = 40;
for i=1:1:height
    for j=1:1:length-i
        epi{1}(startingX+j,startingY+i) =c_eps_0*11.3;
    end
end
...
y0 = yMax/2;
bc{2}.s(1).paras = {mag,phi,omega,betap,t0,st,s,y0,sty,'s'};
